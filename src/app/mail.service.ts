...
/*   onNewMessage(eventName:string) {
  ...
  getcompany(){
    ...
    return this.http.get<any>('http://localhost:3305/company')
  }
  getlikes(){
   
    return this.http.get<any>('http://localhost:3305/all-likes')
  }
  getImage(){
...
addoffre(data: any) {
  return this.http.post<any>('http://localhost:3305/addoffres/',data).subscribe((res: any) => {
